...
export default class AnnounceItemOnStack extends Component {
  constructor(props) {
    super(props)
  ...
  //   return nextProps.item.sessionStarted !== this.props.item.sessionStarted
  // }
        ...
        {(provided, snapshot) => (
          ...
          >
            <Main isDragging={snapshot.isDragging}>
              ...
              />
              <PlayTypeDD>
                {/*<PlayStatusWrapper backgroundColor={'#a7a9ac'} src={DragNDropIcon}{...provided.dragHandleProps}/>*/}
